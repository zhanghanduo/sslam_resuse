...
//	cv::Mat thumbnail;
         ...
         * There are thousands of keypoints generated from fast detection used for loop detection.
         */
         ...
         * This is inherited from sslam estimator jus to validate the correctness using fundamental matrix.
         * The number of window_keypoints is not enough for loop detection.
         */
