...
namespace noiseFactor {
    ...
    ProjectionTwoFrameTwoCamFactor::ProjectionTwoFrameTwoCamFactor(Eigen::Vector3d _pts_i,
    ...
    bool
    ProjectionTwoFrameTwoCamFactor::Evaluate(double const *const *parameters, double *residuals,
...
#if 1
                jacobian_feature =
                        reduce * ric2.transpose() * Rj.transpose() * Ri * ric * pts_i_td * -1.0 /
                        (inv_dep_i * inv_dep_i);
#else
